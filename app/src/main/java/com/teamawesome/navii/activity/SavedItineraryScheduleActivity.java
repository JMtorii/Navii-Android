...
import com.teamawesome.navii.fragment.main.SavedItineraryScheduleMapFragment;
import com.teamawesome.navii.fragment.main.SavedItineraryScheduleViewFragment;
 ...
 */
public class SavedItineraryScheduleActivity extends NaviiToolbarActivity implements SavedItineraryScheduleViewFragment.OnItineraryChangedListener {
...
//        overridePendingTransition(R.anim.slide_in_down, R.anim.hold);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        mAdapter.addFragment(new SavedItineraryScheduleViewFragment(), "Schedule");
        mAdapter.addFragment(new SavedItineraryScheduleMapFragment(), "Map");
    ...
    private void updateMapFragment() {
        SavedItineraryScheduleMapFragment mapFragment = (SavedItineraryScheduleMapFragment) mAdapter.getItem(1);
